...
for lam in v_lambdas:
    print (lam(test_value),end=' ') #Imprime siempre test_value + cant - 1, porque i fue tomado por referencia
print ('\n')
...
i = 0
for lam in v_lambdas_2:
    print (lam(test_value), end = ' ') #Imprime siempre test_value, porque i fue tomado por referencia y ahora vale 0.
print ('\n')
